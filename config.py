...
# Bot & Channel Info
OWNER_USERNAME = getenv("OWNER_USERNAME", "TG_GP_IRAN")
BOT_USERNAME = getenv("BOT_USERNAME", "MusicHarmony11Bot")
...
# Git Configs
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Magichidden/STRANGER-MUSIC")
